...
const INSPECT_EXPORT_HELP_FULL_EXAMPLES: &str = "\nExtended Examples:\n\n  Operator-summary table output:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --table\n\n  Open the interactive inspect workbench over export artifacts:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --interactive\n\n  Inspect a combined multi-org export root directly:\n    grafana-util dashboard analyze --import-dir ./dashboards --input-format raw --output-format tree-table\n\n  Inspect a file-provisioning tree from the provisioning root:\n    grafana-util dashboard analyze --import-dir ./dashboards/provisioning --input-format provisioning --output-format tree-table\n\n  Datasource governance tables:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format governance\n\n  Machine-readable governance contract JSON:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format governance-json\n\n  Dashboard-first grouped tables:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format tree-table\n\n  Narrow to one datasource and one panel id:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format tree-table --report-filter-datasource prom-main --report-filter-panel-id 7\n\n  Inspect query analysis fields such as metrics, functions, and buckets:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format csv --report-columns panel_id,ref_id,datasource_name,metrics,functions,buckets,query\n\n  Audit dashboard tags and per-panel variable and datasource counts:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format csv --report-columns dashboard_tags,panel_id,panel_query_count,panel_datasource_count,query_variables,panel_variables\n\n  Compare Grafana folder identity, slash paths, depth, and source file paths:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format csv --report-columns dashboard_uid,folder_path,folder_full_path,folder_level,folder_uid,parent_folder_uid,file\n\n  Inspect datasource-level org, database, bucket, or index-pattern fields:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format csv --report-columns datasource_name,datasource_org,datasource_org_id,datasource_database,datasource_bucket,datasource_index_pattern,query\n\n  Trim the per-query columns for flat or tree-table output:\n    grafana-util dashboard analyze --import-dir ./dashboards/raw --input-format raw --output-format tree-table --report-columns dashboard_uid,datasource_uid,datasource_family,query,file\n";
