...
#[path = "alert_support_documents.rs"]
mod alert_support_documents;
#[path = "alert_support_io.rs"]
mod alert_support_io;
#[path = "alert_support_normalize.rs"]
mod alert_support_normalize;
#[path = "alert_support_paths.rs"]
mod alert_support_paths;
#[path = "alert_support_policy.rs"]
mod alert_support_policy;
#[path = "alert_support_scaffold.rs"]
